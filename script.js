...
function add() {
  ...
  val3[x] = document.getElementById("email").value;
  val4[x] = document.getElementById("address").value;
  val5[x] = document.getElementById("pincode").value;
  ...
  val7[x] = selectedFoods.join(", ");
  val8[x] = document.getElementById("state").value;
  val9[x] = document.getElementById("country").value;
